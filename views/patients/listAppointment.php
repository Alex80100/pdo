<div class="container">
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <td>
                    <p class="txtTr"> Date & Heure </p>
                </td>
                <td>
                    <p class="txtTr"> Patients </p>
                </td>
                <td>
                    <p class="txtTr"> Modification </p>
                </td>
                <td>
                    <p class="txtTr"> Suppression </p>
                </td>
            </tr>
        </thead>
        <tbody>
            ...
            <?php foreach ($appointmentList as $appointment) { ?>
                <tr>
                    ...
                    <td> <?= '<p class="txtTr">' ?><a class="linkModify" href="/controllers/modifyAppointmentCtrl.php?id=<?= $appointment->idAppointments ?>">MODIFIER</a></p></td>
                    <td> <?= '<p class="txtTr">' ?><a class="linkDelete" href="/controllers/listAppointmentsCtrl.php?id=<?= $appointment->idAppointments ?>">SUPPRIMER</a></p></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
    ...
    <p class="text-center text-warning"><?= $deletePatient ?? '' ?></p>
</div>